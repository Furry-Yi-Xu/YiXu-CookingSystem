...
public class CookingGUIConfig {
    ...
    public static String getTitle() {
        return ConfigManager.getGuiConfig().getConfig().getString(GUI_PATH + "title");
    }
    ...
    public static String getMaterial(String key) {
        return ConfigManager.getGuiConfig().getConfig().getString(DISPLAY_PATH + key + ".display.material");
    }

    public static int getModelData(String key) {
        return ConfigManager.getGuiConfig().getConfig().getInt(DISPLAY_PATH + key + ".display.data");
    }

    public static String getName(String key) {
        return ConfigManager.getGuiConfig().getConfig().getString(DISPLAY_PATH + key + ".display.name");
    }

    public static List<String> getLore(String key) {
        return ConfigManager.getGuiConfig().getConfig().getStringList(DISPLAY_PATH + key + ".display.lore");
    }

    public static int getButtonSlot(String key) {
        return ConfigManager.getGuiConfig().getConfig().getInt(DISPLAY_PATH + key + ".display.slot");
    }
