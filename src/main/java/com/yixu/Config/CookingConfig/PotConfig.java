...
public class PotConfig {
    ...
    public static List<Double> getCookingIngredientHologramOffset() {
        return ConfigManager.getPotConfig().getConfig().getDoubleList(COOKING_INGREDIENT_PATH + "hologram.offset");
    }

    public static List<String> getCookingIngredientHologramLines() {
        return ConfigManager.getPotConfig().getConfig().getStringList(COOKING_INGREDIENT_PATH + "hologram.lines");
    }

    public static List<Double> getCookingProcessHologramOffset() {
        return ConfigManager.getPotConfig().getConfig().getDoubleList(COOKING_PROCESS_PATH + "hologram.offset");
    }

    public static List<String> getCookingProcessHologramLines() {
        return ConfigManager.getPotConfig().getConfig().getStringList(COOKING_PROCESS_PATH + "hologram.lines");
    }
}
